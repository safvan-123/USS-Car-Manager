...
//           axios.get(`http://localhost:5000/api/expenses/car/${carId}`),
//           axios.get(`http://localhost:5000/api/earnings/car/${carId}`),
//         ]);
...
//     // Calculate totals with proper field handling
//     const totalExp = filteredExp.reduce((sum, expense) => {
//       // Handle both 'amount' and 'totalAmount' fields for expenses
//       const amount = expense.totalAmount || expense.amount || 0;
//       return sum + Math.round(Number(amount));
//     }, 0);

//     const totalEarn = filteredEarn.reduce((sum, earning) => {
//       // Handle 'amount' field for earnings
...
//                                   {earning.source || "Earning Transaction"}
//                                 </p>
//                                 <small className="text-muted">
//                                   {earning.notes || "No description"}
//                                 </small>
//                               </div>
...
//         setEarnings(earnRes.data);
//         setFilteredExpenses(expRes.data);
//         setFilteredEarnings(expRes.data); // Initialize with fetched data
//         setFilteredEarnings(earnRes.data);
//       } catch (err) {
//         console.error("Error fetching data:", err);
//       } finally {
...
//                 <div className="card-body p-4">
//                   <h5 className="fw-bold mb-3 d-flex align-items-center">
//                     <i className="bi bi-person-fill-gear me-2 text-info"></i>
//                     Partner Breakdown
//                   </h5>
//                   <div className="row g-3">
