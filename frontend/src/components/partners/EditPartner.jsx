      ...
      >
        <div className="card-body p-4">
          <h2 className="fw-bold mb-2">
            <i className="bi bi-pencil-square me-2"></i>Edit Partner
          </h2>
          <p className="opacity-75">Update partner details</p>
        </div>
      </div>
        ...
        <div className="col-xl-8 col-lg-10 col-12">
          ...
          >
            ...
            >
              ...
              >
                <i
                  className="bi bi-person-lines-fill fs-3"
                  style={{ color: "#0072ff" }}
                ></i>
              </div>
            </div>
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-12">
                    ...
                    <select
                      ...
                      value={partner.car?._id || partner.car}
                  ...
                  <div className="col-md-6">
                    <label className="form-label fw-semibold">
                      <i className="bi bi-phone me-2 text-primary"></i>Phone
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-md-6">
                    <label className="form-label fw-semibold">
                      <i className="bi bi-bank me-2 text-primary"></i>Account No
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-md-6">
                    <label className="form-label fw-semibold">
                      <i className="bi bi-cash me-2 text-primary"></i>UPI ID
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="col-md-6">
                    <label className="form-label fw-semibold">
                      <i className="bi bi-percent me-2 text-primary"></i>Share %
                    </label>
                    <input
                      type="number"
                  ...
                  <div className="col-12">
                    <label className="form-label fw-semibold">
                      <i className="bi bi-camera me-2 text-primary"></i>Partner
                      Photo
                    </label>
                    <input
                      type="file"
